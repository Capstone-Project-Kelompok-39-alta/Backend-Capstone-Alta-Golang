...
// NewSendCustomerService creates a new instance of SendCustomerService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSendCustomerService(t testing.TB) *SendCustomerService {
	mock := &SendCustomerService{}
	mock.Mock.Test(t)
